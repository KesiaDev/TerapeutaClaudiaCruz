...
import claudiaHero from '../src/assets/DSC02199.jpg';
            ...
            <div className="flex flex-col items-start gap-8">
              ...
              <div className="flex flex-col items-start gap-4">
                <div className="flex flex-wrap gap-4">
                  <a href="/#/agendar" className="bg-[#c46a3a] text-white px-8 py-4 rounded-md font-bold hover:bg-opacity-90 transition-all">
                    Agendar Atendimento
                  </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={service.title} className="group cursor-pointer">
                ...
                <Link to={service.to} className="text-xs font-semibold text-[#c46a3a] uppercase tracking-wider flex items-center gap-1 group-hover:opacity-80 transition-opacity">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col gap-8 order-1 md:order-2 items-start">
              ...
              <div className="space-y-6 text-left">
                {[
                  { icon: 'verified', title: 'Técnicas respaldadas por estudos e acompanhamento de resultados.', desc: 'Tratamentos com eficácia comprovada pela ciência psicológica.' },
