      ...
      <section className="w-full max-w-[1200px] mx-auto px-6 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          <div className="w-full md:w-1/2">
            <div className="aspect-[3/4] w-full rounded-2xl overflow-hidden shadow-2xl">
          ...
          {[
            ...
            item.isCta ? (
              <div key={idx} className="flex flex-col items-center justify-center text-center gap-6 p-8 bg-[#c46a3a] rounded-2xl shadow-lg shadow-[#c46a3a]/30 text-white">
                ...
                <a href="/#/agendar" className="w-full bg-white text-[#c46a3a] font-bold py-4 rounded-lg hover:bg-slate-50 transition-colors shadow-sm text-center block">
                  Agendar agora
                </a>
              </div>
            ) : (
